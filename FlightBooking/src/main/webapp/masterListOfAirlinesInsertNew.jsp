...
<title>Insert New Airline Form</title>
...
<div class="col-md-6 col-lg-4 offset-lg-4 offset-md-3 mt-5">
    <div class="bg-light p-5 border shadow">
        ...
        <form action="AirlineController" method="post">                
                  <div class="mb-4">
                   <h5 class="mb-4 text-center">Insert New Airline Form</h5>
                   </div>
			...
			<div class="mb-3">               
            <p class="form-text mb-1">Enter Airline  Name</p>
                <input type="text" name="txtAirlineName" class="form-control"  required placeholder="Enter Airline">
                <p class="form-text text-end text-danger"><%if(request.getAttribute("err1")!=null){
                	  out.print(request.getAttribute("err1")); }%></p>
            </div>           
            
            <button name="button" value="airInsertNew" type="submit" class="btn btn-success w-100 my-3 shadow">Insert New Airline</button>
            <button type="reset" class="btn btn-danger w-100 shadow">Clear</button>
              </form>
              
           <!-- code for going back to masterListOfAirlines  -->   
           <form action="AirlineController" method="post">   
