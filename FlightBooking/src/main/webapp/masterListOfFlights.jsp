...
<title>Master List Of Flights Page</title>
...
<body>
	...
	<div class="container ">
		<h1 class="text-primary text-center">
			...
			&nbsp; &nbsp; &nbsp;  <a type="button"
				href="FlightController"
				class="btn btn-success btn-sm">Add New Flight</a>
		</h1>

	</div>
   <!-- message to display if record deleted -->
		...
		<table class="table table-hover">
    		...
    		%>
				...
				<tr class="table-light text-dark">
					...
					<td><form method="post" action="FlightController">
							<button type="submit" value="flightEdit" name="button"
