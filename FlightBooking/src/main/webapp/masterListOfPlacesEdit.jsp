  ...
  <path fill-rule="evenodd"
	...
	<div class="col-md-6 col-lg-4 offset-lg-4 offset-md-3 mt-5">
		<div class="bg-light p-5 border shadow">
			...
			<form action="Master_S_To_DList_Controller" method="post">
				<div class="mb-4">
					<h5 class="mb-4 text-center">Update Source To Destination
						Location Form</h5>
				</div>
				...
				%>
				<%!Source_To_Destination bean = null;%>

				<%
				if (request.getAttribute("editS_D_Record") != null) {
					bean = (Source_To_Destination) request.getAttribute("editS_D_Record");
				}
				%>
				...
				<div class="mb-3">
					...
					<input type="text" name="txtsource" placeholder="Enter Source City"
	...
	out.print(bean.getSource());
				...
				<div class="mb-3">
					...
					<input type="text" name="txtdestination" required
	...
	out.print(bean.getDestination());
				...
				<input type="hidden" name="sdid" value=<%=bean.getSdid()%>>

				<button name="button" value="update" type="submit"
					<%if (request.getAttribute("msg") != null) {
	out.print("disabled=disabled");
}%>
					class="btn btn-success w-100 my-3 shadow">Update Route</button>

			</form>

			<form action="AdminController" method="post">
				<button class="btn btn-success w-100 my-3 shadow" name="button"
					value="masterListOfPlaces" type="submit">
