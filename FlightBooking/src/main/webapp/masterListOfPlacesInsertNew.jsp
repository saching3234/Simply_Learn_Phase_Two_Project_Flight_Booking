...
<title>Insert New Source To Destination Location Form</title>
...
<div class="col-md-6 col-lg-4 offset-lg-4 offset-md-3 mt-5">
    <div class="bg-light p-5 border shadow">
        <!-- Login Form -->
        <form action="Master_S_To_DList_Controller" method="post">                
                  <div class="mb-4">
                   <h5 class="mb-4 text-center">Insert New Source To Destination Location Form</h5>
                   </div>
            ...
            <p class="form-text mb-1">Enter Source City Name</p>
                <input type="text" name="txtsource" class="form-control"  required placeholder="Enter Source City">
                <p class="form-text text-end text-danger"><%if(request.getAttribute("err1")!=null){
                	  out.print(request.getAttribute("err1")); }%></p>
            </div>
            <div class="mb-3">
                <p class="form-text mb-1">Enter Destination City Name</p>
                <input type="text" name="txtdestination" required class="form-control" placeholder="Enter Destination City">
                 <p class="form-text text-end text-danger"><%if(request.getAttribute("err2")!=null){
                	  out.print(request.getAttribute("err2")); }%></p>
            </div>
            
            <button name="button" value="sdInsert" type="submit" class="btn btn-success w-100 my-3 shadow">Insert Route</button>
            <button type="reset" class="btn btn-danger w-100 shadow">Clear</button>
              </form>
              
          <form action="AdminController" method="post">   
          <button class="btn btn-success w-100 my-3 shadow" name="button" value="masterListOfPlaces" type="submit" >
          ...
          <path d="M.5 3.5A.5.5 0 0 0 0 4v8a.5.5 0 0 0 1 0V8.753l6.267 3.636c.54.313 1.233-.066 1.233-.697v-2.94l6.267 3.636c.54.314 1.233-.065 1.233-.696V4.308c0-.63-.693-1.01-1.233-.696L8.5 7.248v-2.94c0-.63-.692-1.01-1.233-.696L1 7.248V4a.5.5 0 0 0-.5-.5z"/>
              ...
              Go Back To Master List Of places             
        </button>
       </form> 
