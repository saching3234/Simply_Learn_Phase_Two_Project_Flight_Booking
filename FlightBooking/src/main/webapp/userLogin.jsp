  ...
  <path
...
</svg> Flight Booking User Login Page</a>
			...
			<div class="collapse navbar-collapse" id="navbarColor01">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item"><a class="nav-link active mx-1">Not
							Registed User <span class="visually-hidden">(current)</span>
					</a></li>

					<li class="nav-item"><a
						class="nav-link btn btn-warning text-dark mx-1"
						href="userSearchHomePage.jsp">Search Flight And Register <svg
								xmlns="http://www.w3.org/2000/svg" width="16" height="16"
	...
	<div class="col-md-6 col-lg-4 offset-lg-4 offset-md-3 mt-5">
		<div class="bg-light p-5 border shadow">
			...
			<form action="UserController" method="post">
				<div class="mb-4">
					<h3 class="mb-4 text-center">User Sign In</h3>
				</div>
				...
				<button name="button" value="userLogin" type="submit"
